    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (inventario.getProductos().isEmpty()) {
                ...
                Logger.info("Stock de productos agotados restaurado automaticamente");
            }
        } catch (Exception e) {
            Logger.error(e, "Error al cargar inventario");
            Logger.warning("Inicializando inventario vacio");
            ...
            try {
                switch (opcion) {
                    ...
                    default:
                        ...
                        Logger.warning("Opcion invalida seleccionada: " + opcion);
                }
            } catch (Exception e) {
