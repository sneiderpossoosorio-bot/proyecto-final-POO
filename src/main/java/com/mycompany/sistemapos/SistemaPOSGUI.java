...
/**
 * Interfaz gráfica para el menú principal del Sistema POS
 * 
 * Esta clase proporciona una interfaz gráfica simple para acceder
 * a las funcionalidades del sistema POS.
 */
public class SistemaPOSGUI {
    ...
    /**
     * Abre la gestión de mesas (versión básica para avance)
     */
    ...
    /*Muestra el inventario en un diálogo*/
    ...
    /**
     * Muestra un reporte en un diálogo
     */
    ...
    /**
     * Obtiene el texto del reporte (versión básica para avance)
     */
